    ...
    def run(self):
        ...
        if result:
            ...
            for row_no in range(6, num_lines - 1):
                ...
                # 長い不要な文字列の置き換え
                line_rep_8 = line_rep_7.replace("type:Feature,properties:", "")
                ...
                ver_num = str(vertex)
                line_rep_9 = line_rep_8.replace("geometry:type:MultiLineString,coordinates:", ver_num)

                # コロンをコンマに置き換え
                line_rep_10 = line_rep_9.replace(":", ",")
